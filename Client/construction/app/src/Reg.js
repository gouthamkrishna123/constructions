...
//                     <input type="text" style={{width:"60%",backgroundColor:"#353a43",border:"none",borderBottom:"2px solid gray",height:"40px",marginLeft:"60px",color:"gray"}} className="form-control" id="username" placeholder="User Name" name="username" value={data.username} onChange={(e,username)=>handle(e,username)} required/>
                    
//                     {/* {errors.username && <div classname="invalid-feedback">{errors.username}</div>} */}
//                     <br/><br/>

//                         <input type="email" style={{width:"60%",backgroundColor:"#353a43",border:"none",borderBottom:"2px solid gray",height:"40px",marginLeft:"60px",color:"gray"}} className="form-control" pattern=".+@example\.com" id="email" placeholder="Email" name="email" value={data.email} required onChange={(e,email)=>handle(e,email)}/>
