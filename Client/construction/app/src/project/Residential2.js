        ...
        <>
         <div>
          <div style={{backgroundColor:"black"}}>
            ...
            <h1 style={{textAlign:"left",marginTop:"-200px",marginBottom:"200px",fontSize:"70px",color:"white"}}>Residential Home 3</h1>
            </div>
...
<div className="card-mb-2">
        ...
        <div style={{backgroundColor:"white"}} className="row g-0">
                  ...
                  <img style={{width:"100%",height:"500px"}} src={new5} alt="images"/>
                    ...
                    <div className="col-md-3" id="one" style={{}}>
                        ...
                        <div><br/>
                            <div className="row g-0">
                                <div className="">
                                <p>Designer : Syamjith</p>
                                    <p>Client : Sudeep Kumar</p>
                                    <p>Location : Ollur</p>
                                    <p>Start date : Start Soon</p>
